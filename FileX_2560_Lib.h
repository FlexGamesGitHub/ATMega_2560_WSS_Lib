...
/* TODO
- Invertion Invertion 
- All Register Single IO
*/


#ifdef __FILEX_LIB_ARDUINO

// No need of the premade loop() or setup(), just continue as you are used to
int main(void);
void loop(void) { main(); }
...
static void std_init(char interrupts[8]) {
    DDRA = 0xFF; DDRB = 0xFF; DDRC = 0xFF; DDRE = 0x00; DDRG = 0xFF; DDRH = 0xFF; DDRK = 0x00; 
...
/*
Hoffentlich kommt das hier zu einem guten Einsatz
Und hoffentlich bleibt Hr. Ka weiterhin Lehrer. Er ist in der Top 2 der Lehrer die ich bisher hatte.
- FileX
*/
